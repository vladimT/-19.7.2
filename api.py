...
class PetFriends:
    ...
    def add_pet_simple(self, auth_key: json, name:str,
                       animal_type: str, age: int) -> json:
    ...
    def set_pet_photo(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """Метод отправляет запрос на сервер об обновлении изображения питомуа по указанному ID и
        возвращает статус запроса и result в формате JSON с обновлённым изображением питомца"""
